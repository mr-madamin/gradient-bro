...
Run `npm run preview` in the repository and open `/examples/` to browse focused examples for basic colors, gradient editing, form integration, theming, programmatic control, and compact trigger UIs.
